...
struct IslandMenu: View {
    ...
    private func fetchIslandsNear(location: CLLocationCoordinate2D) -> [PirateIsland] {
        let distance: CLLocationDistance = 1000
        return PirateIsland.fetchIslandsNear(location: location, within: distance, in: viewContext)
    }
}
