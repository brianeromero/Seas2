...
extension AppDayOfWeek {
    ...
    @NSManaged public var pirateIslands: NSSet?

}

// MARK: Generated accessors for pirateIslands
extension AppDayOfWeek {

    @objc(addPirateIslandsObject:)
    @NSManaged public func addToPirateIslands(_ value: PirateIsland)

    @objc(removePirateIslandsObject:)
    @NSManaged public func removeFromPirateIslands(_ value: PirateIsland)

    @objc(addPirateIslands:)
    @NSManaged public func addToPirateIslands(_ values: NSSet)

    @objc(removePirateIslands:)
    @NSManaged public func removeFromPirateIslands(_ values: NSSet)
